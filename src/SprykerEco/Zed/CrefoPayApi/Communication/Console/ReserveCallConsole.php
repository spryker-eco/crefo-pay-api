 ...
 */
class ReserveCallConsole extends Console
{
    public const COMMAND_NAME = 'crefo-pay-api:reserve';
    public const COMMAND_DESCRIPTION = 'Perform Reserve API call to CrefoPay';
    ...
    {
        $response = $this->getFacade()->performReserveApiCall($this->createRequestTransfer());
