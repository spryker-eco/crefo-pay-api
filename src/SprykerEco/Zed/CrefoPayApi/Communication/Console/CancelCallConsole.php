 ...
 */
class CancelCallConsole extends Console
{
    public const COMMAND_NAME = 'crefo-pay-api:cancel';
    public const COMMAND_DESCRIPTION = 'Perform Cancel API call to CrefoPay';
    ...
    {
        $response = $this->getFacade()->performCancelApiCall($this->createRequestTransfer());
