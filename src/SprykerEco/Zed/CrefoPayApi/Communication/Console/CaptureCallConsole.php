 ...
 */
class CaptureCallConsole extends Console
{
    public const COMMAND_NAME = 'crefo-pay-api:capture';
    public const COMMAND_DESCRIPTION = 'Perform Capture API call to CrefoPay';
    ...
    {
        $response = $this->getFacade()->performCaptureApiCall($this->createRequestTransfer());
